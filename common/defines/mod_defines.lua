...
NDefines.NDiplomacy.TENSION_ANNEX_NO_CLAIM = 0                       -- Vanilla: 2
NDefines.NDiplomacy.TENSION_ANNEX_CLAIM = 0                           -- Vanilla: 1
...
NDefines.NDiplomacy.WARGOAL_WORLD_TENSION_REDUCTION = 13
...
NDefines.NProduction.MAX_MIL_FACTORIES_PER_LINE = 15
...
NDefines.NAir.DAY_NIGHT_COVERAGE_FACTOR = 1.0
NDefines.NAir.DETECT_CHANCE_FROM_NIGHT = 0.0
NDefines.NAir.CAS_NIGHT_ATTACK_FACTOR = 0.0

--NDefines.NFocus.FOCUS_PROGRESS_PEACE = 1
--NDefines.NFocus.FOCUS_PROGRESS_WAR = 1

NDefines.NGame.MISSION_REMOVE_FROM_INTERFACE_DEFAULT = 4
...
--NDefines.NSupply.SUPPLY_HUB_FULL_MOTORIZATION_BONUS = 0.0
--NDefines.NSupply.SUPPLY_HUB_FULL_MOTORIZATION_TRUCK_COST = 0.0

--NDefines.NAI.UPDATE_SUPPLY_MOTORIZATION_FREQUENCY_HOURS = 69696969696969 --would -1 disable the AI?
...
NDefines.NMilitary.FIELD_MARSHAL_ARMIES_CAP = -1

NDefines.NMilitary.FIELD_MARSHAL_ARMY_BONUS_RATIO = 0.0
...
NDefines.NIntel.NAVAL_SUPREMACY_INTEL_LOW = -1.0

NDefines.NAI.MIN_INVASION_PLAN_VALUE_TO_EXECUTE = 0

NDefines.NAir.STRATEGIC_BOMBER_NUKE_AIR_SUPERIORITY = 0.5
NDefines.NCountry.NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_VP = 10
NDefines.NCountry.NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0.05
