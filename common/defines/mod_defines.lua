...
NDefines.NCountry.BASE_COMMAND_POWER_GAIN = 0.0      -- Vanilla: 0.4
--NDefines.NCountry.STARTING_COMMAND_POWER = -10.0
NDefines.NCountry.BASE_MAX_COMMAND_POWER = -1.0
NDefines.NAI.NEW_LEADER_EXTRA_CP_FACTOR = -1.0
