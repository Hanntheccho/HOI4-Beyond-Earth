...
// ------------------    TERRAIN        -------------------------
// --------------------------------------------------------------
static const float CITY_LIGHTS_TILING 			= 0.04103; // used to be 0.03103
static const float CITY_LIGHTS_INTENSITY 		= 9.0; // used to be 7.5
static const float CITY_LIGHTS_BLOOM_FACTOR 	= 0.6; // used t be 0.5
...
static const float 	SNOW_OPACITY_MIN			= 0.0f; //
static const float 	SNOW_OPACITY_MAX			= 0.0f; //
static const float 	SNOW_CAM_MIN 				= 0.0f; //
static const float 	SNOW_CAM_MAX 				= 1.0f; //
...
static const float WATER_COLOR_LIGHTNESS = 1.0;
